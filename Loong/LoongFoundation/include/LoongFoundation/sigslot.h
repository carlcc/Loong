...
public:
    multi_threaded_local() = default;
    multi_threaded_local(const multi_threaded_local&) = delete;
    multi_threaded_local(multi_threaded_local&&) = delete;
    multi_threaded_local& operator=(const multi_threaded_local&) = delete;
    multi_threaded_local& operator=(multi_threaded_local&&) = delete;
    ~multi_threaded_local() = default;
